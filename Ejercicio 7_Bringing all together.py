...
'''def sub_bytes(state, sbox):
    ...
    for state_row in range(len(state)):
        ...
        for state_col in range(len(state[state_row])):
            ...
            s_row, s_col = int(val[2], 4), int(val[3], 4)
            sbox_val = sbox[4 * s_row + s_col]
...
'''def decrypt(self, data):
        ...
        if method == EncryptionMethod.AES_ECB:
            ...
            try:
                ...
                return None
            return data 
ciphertext='6a36021d7f51a4c90b149d5e52bede7d12d9436a06f168a61d1bda639e1dad51'
key= '02596e7c'
text='686f6c61'
...
print(encryption_oracle_aes(text))'''